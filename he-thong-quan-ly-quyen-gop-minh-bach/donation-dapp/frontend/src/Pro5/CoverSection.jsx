...
const CoverSection = ({ user }) => {
  // Lấy logo mới nhất làm avatar (khi đã tạo quỹ)
  const getLatestLogo = () => {
  ...
  return (
    <div style={{ background: "#f0f2f5", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      {/* ẢNH BÌA - NHỎ LẠI, TỈ LỆ ĐẸP */}
      <div
        style={{
          position: "relative",
          width: "100%",
          height: 0,
          paddingBottom: "28%", // NHỎ LẠI từ 37.5% → 28% (rất vừa mắt)
          overflow: "hidden",
          background: "#000",
        }}
      >
      ...
      {/* PHẦN TRẮNG DƯỚI ẢNH BÌA + AVATAR + TÊN */}
